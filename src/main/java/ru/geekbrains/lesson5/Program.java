...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        while (f){
            ...
            System.out.println("7. Удалить все текстуры проекта");
            System.out.println("8. Выполнить рендер модели");
...
class EditorDatabase implements Database{
    ...
    @Override
    public void remove() {
        //TODO: Удаление всех сущностей проекта
    }
